...
var CreatedEventData = require('./created');
var BatchCreatedEventData = require('./batch-created');
var UpdatedEventData = require('./updated');
var FetchedEventData = require('./fetched');
var DeletedEventData = require('./deleted');
var ModelTransformStream = require('./transform-stream');
...
function MongoRepo(db, options) {
  ...
  var _idOp;
  var _timestampOnCreate = utilities.pointers.prepare(options.timestampOnCreate);
  var _timestampOnUpdate = utilities.pointers.prepare(options.timestampOnUpdate);
  ...
  Object.defineProperties(this, {
    ...
    _timestampOnCreate: {
      ...
      set: function(val) {
        ...
        _timestampOnCreate = utilities.pointers.prepare(val);
      },
      enumerable: true
    },
    ...
    _timestampOnUpdate: {
      ...
      set: function(val) {
        ...
        _timestampOnUpdate = utilities.pointers.prepare(val);
      },
      enumerable: true
    },
...
Object.defineProperties(MongoRepo.prototype, {
  ...
  _beforeCreateDataModel: {
    ...
    value: function _beforeCreateDataModel(data) {
      ...
      if (pointers) {
        utilities.pointers.setTimestampForAll(data, pointers);
      }
      return data;
    },
    enumerable: true,
        ...
        self._collection.findOne(idRef, function(err, data) {
          ...
          if (changes.$set || changes.$unset) {
            if (self._timestampOnUpdate) {
              ...
              utilities.pointers.setValueForAll(changes.$set, self._timestampOnUpdate, new Date());
            }
